                ...
                <tr>
                    <td class="border-0 pl-0" width="70%">
                        <h4 class="text-uppercase">
                            <strong>{{ $invoice->name }} / Recovery</strong>
                        </h4>
                    </td>
...
{{--        </p>--}}
        ...
        <table class="table mt-5">
            ...
            <tr>
                <td class="border-0 pl-0" width="50%">
                    Mühəndis :
                    <div style="border-top: 1px solid #000; width: 50%; margin-top: 20px;"></div>
                </td>
            </tr>
        ...
        {{-- Footer --}}
        <p class="text-center">
            Tel: (+99455) 594 90 14 Mob: (+99455) 783 00 33 Veb səhifə: www.recovery.az E-mail: info@recovery.az
